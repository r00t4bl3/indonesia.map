...
<head>
    ...
    <!-- Bootstrap -->
    <link href="css/bootstrap.adjie.min.css" rel="stylesheet">
    ...
    path.indonesia { fill: #fff; }
    path:hover { fill: #fff; }
    .svg-wrapper { display: inline-block; position: relative; width: 100%; vertical-align: middle; }
    .svg-wrapper svg { display: inline-block; position: relative; top: 0; left: 0;  width: 100%; }
    .extra-margin { margin-top: 10px; margin-bottom: 10px; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="svg-wrapper">
                    <svg version="1.1" viewBox="-505.201 -274.435 2020.805 921.798" preserveAspectRatio="xMinYMin meet">
                        <path
                        class="indonesia banten"
                        stroke="#333333"
                        stroke-width="1.4286"
                        ...
                        id="path21" />
                        <path
                        class="indonesia sumatera-selatan"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path27" />
                        <path
                        class="indonesia sumatera-barat"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path49" />
                        <path
                        class="indonesia bangka-belitung"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path53" />
                        <path
                        class="indonesia sumatera-utara"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path77" />
                        <path
                        class="indonesia kalimantan-barat"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path83" />
                        <path
                        class="indonesia kalimantan-tengah"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path85" />
                        <path
                        class="indonesia kalimantan-timur"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path87" />
                        <path
                        class="indonesia kalimantan-selatan"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path95" />
                        <path
                        class="indonesia sulawesi-utara"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path99" />
                        <path
                        class="indonesia sulawesi-tenggara"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path117" />
                        <path
                        class="indonesia sulawesi-tengah"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path121" />
                        <path
                        class="indonesia sulawesi-barat"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path125" />
                        <path
                        class="indonesia sulawesi-selatan"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path129" />
                        <path
                        class="indonesia nusa-tenggara-timur"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
                        ...
                        id="path151" />
                        <path
                        class="indonesia nusa-tenggara-barat"
                        stroke="#333333"
                        stroke-width="1.4286"
                        stroke-linejoin="round"
            ...
            <div class="col-md-4">
                <button class="btn btn-primary btn-show-indonesia extra-margin">Indonesia</button>
                <button class="btn btn-default btn-show-banten extra-margin">Banten Province</button>
                <button class="btn btn-success btn-show-diy extra-margin">Yogyakarta Province</button>
                <button class="btn btn-danger btn-show-jawa-barat extra-margin">Jawa Barat Province</button>
                <button class="btn btn-warning btn-show-jawa-tengah extra-margin">Jawa Tengah Province</button>
            </div>
        </div>
    </div>
    ...
    <script>
    $(function () {
        $(' .btn-show-indonesia ').on('click', function() {
            $(' path.indonesia ').css('fill', "#0f0");
        });
        $(' .btn-show-banten ').on('click', function() {
            $(' path.indonesia ').css('fill', "#fff");
            $(' path.banten ').css('fill', "#0f0");
        });
        $(' .btn-show-diy ').on('click', function() {
            $(' path.indonesia ').css('fill', "#fff");
            $(' path.di-yogyakarta ').css('fill', "#0f0");
        });
        $(' .btn-show-jawa-barat ').on('click', function() {
            $(' path.indonesia ').css('fill', "#fff");
            $(' path.jawa-barat ').css('fill', "#0f0");
        });
        $(' .btn-show-jawa-tengah ').on('click', function() {
            $(' path.indonesia ').css('fill', "#fff");
            $(' path.jawa-tengah ').css('fill', "#0f0");
        });
    });
